...
class Tailer(object):
    ...
    def follow(self, delay=1.0, selector=None, start=None):
        """\
        ...
        while 1:
            ...
            if line:
                ...
                trailing = False
                yield line
            elif selector is not None and not selector():
                return
            else:
                trailing = True
                self.seek(where)
...
def follow(file, delay=1.0, selector=None, start=None):
    """\
    Iterator generator that returns lines as data is added to the file.
    ...
    """
    return Tailer(file, end=True).follow(delay, selector=selector, start=start)
