...
class ElementumRPCServer(BaseHandler):
    ...
    def Dialog_Confirm_With_Timeout(self, title, message, timeout):
        dialog = xbmcgui.Dialog()
        return int(dialog.yesno(getLocalizedLabel(title), getLocalizedLabel(message), nolabel=getLocalizedString(30414), yeslabel=getLocalizedLabel("LOCALIZE[30632];;%d" % timeout)))
