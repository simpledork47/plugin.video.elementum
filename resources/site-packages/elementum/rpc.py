...
class ElementumRPCServer(BaseHandler):
    ...
    def Dialog_Confirm_With_Timeout(self, title, message, focused, timeout):
        ...
        return int(dialog.yesno(getLocalizedLabel(title), getLocalizedLabel(message), nolabel=no, yeslabel=yes, autoclose=timeout * 1000))
    ...
    def Dialog_CloseAllConfirms(self, *args, **kwargs):
        return xbmc.executebuiltin("Dialog.Close(DialogConfirm.xml, true)")
